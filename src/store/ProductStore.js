...
export const useProductRootStore = defineStore("productRoot", () => {
  ...
  const FETCH_PRODUCTS = async () => {
    const res = await fetch("http://10.20.3.72:8099/api/products/all");
    const jsonnew = await res.json();
    products.value = jsonnew;
  };
  const FETCH_ELECRONICS_PRODUCTS = async () => {
    const res = await fetch(
      "http://10.20.3.72:8099/api/products/by-category/Electronics"
    );
    const jsonnew = await res.json();
  ...
  const FETCH_BOOKS_PRODUCTS = async () => {
    const res = await fetch(
      "http://10.20.3.72:8099/api/products/by-category/Books"
    );
    const jsonnew = await res.json();
  ...
  const FETCH_FASHION_PRODUCTS = async () => {
    const res = await fetch(
      "http://10.20.3.72:8099/api/products/by-category/Fashion"
    );
    const jsonnew = await res.json();
  ...
  const FETCH_PRODUCT_BY_ID = async (productId) => {
    const res = await fetch(`http://10.20.3.72:8099/api/products/${productId}`);
    const jsonnew = await res.json();
